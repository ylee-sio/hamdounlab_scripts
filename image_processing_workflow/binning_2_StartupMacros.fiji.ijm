...
selectWindow("w1");
makeLine(0, 300, 870, 300);
run("Set Scale...", "distance=870 known=550 unit=uM font=15 width=50 global");
run("Scale Bar...", "width=50 height=50 thickness=4 font=15 color=White background=None location=[Lower Right] horizontal bold overlay");
...
run("Magenta");
selectWindow("MAX_w2");
setFont("SansSerif", 25, "antialiased");
Overlay.drawString(w2_text, 50, 70);
...
selectWindow("MAX_w3");
setFont("SansSerif", 25, "antialiased");
Overlay.drawString(w3_text, 50, 70);
...
selectWindow("MAX_w4");
setFont("SansSerif", 25, "antialiased");
Overlay.drawString(w4_text, 50, 70);
...
selectWindow("MAX_w5");
setFont("SansSerif", 25, "antialiased");
Overlay.drawString(DAPI_text, 50, 70);
...
run("RGB Color");
run("Scale Bar...", "width=25 height=50 thickness=3 font=25 color=White background=None location=[Lower Right] horizontal bold overlay");
setFont("SansSerif", 25, "antialiased");
run("Colors...", "foreground=magenta, background=magenta, selection=magenta");
drawString(w2_text, 50, 70);
run("Colors...", "foreground=cyan, background=cyan, selection=cyan");
drawString(DAPI_text, 50, 100);
run("Flatten");
