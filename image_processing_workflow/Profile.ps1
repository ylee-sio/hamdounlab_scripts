...
Set-Alias -Name quickfix -Value ./hamdounlab_scripts/image_processing_workflow/wv_quickfix.ps1

echo "Planning on processing some in situ HCR images? Here are the three essential commands:"
echo ""
echo "1) prep_images"
echo "2) imagej"
