...
// Saving steps for single z projected channel images
// Step 2 To be run after manually 1. selecting z stack range 2. z projecting 3. gating
macro "Macro 16 [b]" {
selectWindow("MAX_w2");
run("RGB Color");
saveAs("Tiff", "C:/Users/Yoon Lee/OneDrive - UC San Diego/temp/temp_imagej_outputs_for_transfer/single_channel/w2.tif");
run("16-bit");
run("Magenta");
selectWindow("MAX_w3");
run("RGB Color");
saveAs("Tiff", "C:/Users/Yoon Lee/OneDrive - UC San Diego/temp/temp_imagej_outputs_for_transfer/single_channel/w3.tif");
run("16-bit");
run("Yellow");
selectWindow("MAX_w4");
run("RGB Color");
saveAs("Tiff", "C:/Users/Yoon Lee/OneDrive - UC San Diego/temp/temp_imagej_outputs_for_transfer/single_channel/w4.tif");
run("16-bit");
run("Green");
selectWindow("MAX_w5");
run("RGB Color");
saveAs("Tiff", "C:/Users/Yoon Lee/OneDrive - UC San Diego/temp/temp_imagej_outputs_for_transfer/single_channel/w5.tif");
run("16-bit");
run("Cyan");
run("Merge Channels...", "c6=w2.tif c5=w5.tif create keep");
run("RGB Color");
saveAs("Tiff", "C:/Users/Yoon Lee/OneDrive - UC San Diego/temp/temp_imagej_outputs_for_transfer/single_channel_with_dapi/w2_DAPI.tif");
close();
close();
run("Merge Channels...", "c7=w3.tif c5=w5.tif create keep");
run("RGB Color");
saveAs("Tiff", "C:/Users/Yoon Lee/OneDrive - UC San Diego/temp/temp_imagej_outputs_for_transfer/single_channel_with_dapi/w3_DAPI.tif");
close();
close();
run("Merge Channels...", "c2=w4.tif c5=w5.tif create keep");
run("RGB Color");
saveAs("Tiff", "C:/Users/Yoon Lee/OneDrive - UC San Diego/temp/temp_imagej_outputs_for_transfer/single_channel_with_dapi/w4_DAPI.tif");
close();
close();
}
...
run("RGB Color");
saveAs("Tiff", "C:/Users/Yoon Lee/OneDrive - UC San Diego/temp/temp_imagej_outputs_for_transfer/double_channel/w2_w3.tif");
close();
close();
run("Merge Channels...", "c6=w2.tif c2=w4.tif create keep");
run("RGB Color");
saveAs("Tiff", "C:/Users/Yoon Lee/OneDrive - UC San Diego/temp/temp_imagej_outputs_for_transfer/double_channel/w2_w4.tif");
close();
close();
run("Merge Channels...", "c7=w3.tif c2=w4.tif create keep");
run("RGB Color");
saveAs("Tiff", "C:/Users/Yoon Lee/OneDrive - UC San Diego/temp/temp_imagej_outputs_for_transfer/double_channel/w3_w4.tif");
close();
close();
run("Merge Channels...", "c6=w2.tif c7=w3.tif c5=w5.tif create keep");
run("RGB Color");
saveAs("Tiff", "C:/Users/Yoon Lee/OneDrive - UC San Diego/temp/temp_imagej_outputs_for_transfer/double_channel_with_dapi/w2_w3_DAPI.tif");
close();
close();
run("Merge Channels...", "c6=w2.tif c2=w4.tif c5=w5.tif create keep");
run("RGB Color");
saveAs("Tiff", "C:/Users/Yoon Lee/OneDrive - UC San Diego/temp/temp_imagej_outputs_for_transfer/double_channel_with_dapi/w2_w4_DAPI.tif");
close();
close();
run("Merge Channels...", "c7=w3.tif c2=w4.tif c5=w5.tif create keep");
run("RGB Color");
saveAs("Tiff", "C:/Users/Yoon Lee/OneDrive - UC San Diego/temp/temp_imagej_outputs_for_transfer/double_channel_with_dapi/w3_w4_DAPI.tif");
close();
close();
run("Merge Channels...", "c6=w2.tif c7=w3.tif c2=w4.tif create keep");
run("RGB Color");
saveAs("Tiff", "C:/Users/Yoon Lee/OneDrive - UC San Diego/temp/temp_imagej_outputs_for_transfer/triple_channel/w2_w3_w4.tif");
close();
close();
run("Merge Channels...", "c6=w2.tif c7=w3.tif c2=w4.tif c5=w5.tif create keep");
run("RGB Color");
saveAs("Tiff", "C:/Users/Yoon Lee/OneDrive - UC San Diego/temp/temp_imagej_outputs_for_transfer/triple_channel_with_dapi/w2_w3_w4_DAPI.tif");
close();
close();
}
